    ...
    <?php
      $fname=$field->class;
        ...
        if ($fname == "field-start-date-value" ):
              print '<p class="hsDate"><span class="hsDateDay">' .(module_exists('oubrand') ? oubrand_views_content($nid,$field->content) : $field->content). '</span>';
	      endif;
	
	      if ($fname == "field-start-date-value-1" ):
              print '<span class="hsDateMonth">' . (module_exists('oubrand') ? oubrand_views_content($nid,$field->content) : $field->content) . '</span></p>';
	      endif;
